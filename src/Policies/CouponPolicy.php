...
class CouponPolicy
{
    ...
    {
        return $user->can(['coupon_read', 'coupon_create']);
    }
    ...
    {
        return $user->can(['coupon_read', 'coupon_update']);
    }
    ...
    {
        return $user->can(['coupon_read', 'coupon_delete']);
    }
