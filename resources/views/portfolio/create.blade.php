    ...
    <div class="card-body">
        ...
        <form action="{{route('admin.portfolios.store')}}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" id="title" name="title" class="form-control" required placeholder="Please enter your title..." value="{{ old('title') }}">
            </div>
            <div class="form-group">
                <label for="description">Description</label>
                <textarea name="description" id="description" rows="5" class="form-control" required placeholder="Please enter your description...">{{ old('description') }}</textarea>
            </div>
            <div class="form-group">
                <button type="button" class="btn btn-light mb-3" data-toggle="modal" data-target="#file-manager">
